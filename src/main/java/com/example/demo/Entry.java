...
//                    }
                    ...
                    do {
                           ...
                           }while(!DataValidation.validate_Car_Name(preferred_Car_Name));
...
//            System.out.println("Do you have a specific time in mind to pick and return the car: ");
            ...
            try {
               ...
               // CarRentalWebCrawl.fetch_Car_Deals();
            	...
            	System.out.println(" exceptionn catched no cars availble in that location try again!"); 
    ...
    public static String convert_Date_Format(String inputtDdate) {
        ...
        try {
            ...
            System.out.println("parseExcpetion");
            return null; 
        }
    }
